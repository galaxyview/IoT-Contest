...
extern E53_SC2_Data_TypeDef E53_SC2_Data3;
/* 类型定义 ------------------------------------------------------------------*/
/* 宏定义 --------------------------------------------------------------------*/
...
void PMU6050_ReadData(uint8_t reg_add,unsigned char*Read,uint8_t num, short iicno);
void PMU6050_WriteReg(uint8_t reg_add,uint8_t reg_dat,short iicno);
